                    ...
                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group ">
                                        <label for="name">Dưới mục tài liệu mới nhất</label>
                                        <input type="checkbox" name="e_position_1" value="1">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group ">
                                        <label for="name">Dưới mục tài liệu download nhiều nhất </label>
                                        <input type="checkbox" name="e_position_2" value="1">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group ">
                                        <label for="name">Sidebar Home</label>
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="box-body block-images">
                                <div style="margin-bottom: 10px"> <img src="/images/no-image.jpg" onerror="this.onerror=null;this.src='/images/no-image.jpg';" alt="" class="img-thumbnail" style="width: 100%;height: 100px;"> </div>
