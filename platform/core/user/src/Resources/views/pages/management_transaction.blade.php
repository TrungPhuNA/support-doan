    ...
    <section>
        ...
        <div class="content">
            <div class="table-responsive">
                                ...
                                @if ($pay->ph_credit)
                                    <th class="text-center">
                                        <span class="manage-money">
                                            ...
                                            @endif
                                            {{ number_format($pay->ph_credit,0,',','.') }} <sup>đ</sup>
                                        </span>
                                    </th>
                                @else
                                    <th class="text-center">
                                        <span class="manage-money">
                                            ...
                                            @endif
                                            {{ number_format($pay->ph_debit,0,',','.') }} <sup>đ</sup>
                                        </span>
                                    </th>
                                @endif
                                <th>
                ...
                @if ($payHistories->nextPageUrl())
                    <a class="btn btn-pink btn-radius btn-next-page" href="{{ $payHistories->nextPageUrl() }}">Xem thêm <i class="fa fa-long-arrow-right"></i></a>
                @endif
            </div>
        </div>
    </section>
