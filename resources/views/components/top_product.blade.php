        ...
        @foreach($products as $product)
            <div class="item">
                <div class="item__avatar">
                    <a href="{{ route('get.document.detail',$product->pro_slug . '-'.$product->id ) }}" title="" class="image cover">
                ...
                <div class="item__info">
                    ...
                    @endif
                    <a href="{{ route('get.document.detail',$product->pro_slug . '-'.$product->id ) }}" title="Đồng hồ Diamond D DD6014B" class="name">{{  $product->pro_name }}</a>
                    @if ($product->pro_sale) 
                        <p class="price">
                            <span>Giá bán: </span>
