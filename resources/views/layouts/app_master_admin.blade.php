    ...
    <head>
        ...
        <style>
            @media (max-width: 768px) {
                .form-inline .form-control,.form-inline a ,.form-inline button  {
                    margin-bottom: 5px;
                }
            }
        </style>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown notifications-menu">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="header" id="notifications-count-text"></li>
                                    <li>
...
{{--                                    <li class="footer"><a href="#">Xem tất cả</a></li>--}}
                            ...
                            <li class=" user user-menu">
                                <a href="{{ route('admin.restart.flag_errors_system') }}" >
                                    <span>Restart Flag Error</span>
                                </a>
                            </li>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        @endforeach
                        <li><a href="{{  route('admin.slide.index') }}"><i class="fa fa-circle-o text-red"></i> <span>Slide Trang chủ</span></a></li>
...
{{--                        <li><a href="{{  route('admin.statistical') }}"><i class="fa fa-circle-o text-red"></i> <span>Statistical</span></a></li>--}}
        ...
        <!-- AdminLTE App -->
        <script src="{{  asset('admin/plugins/iCheck/js/icheck.js') }}"></script>
...
{{--        <!-- page script -->--}}
        <script type="text/javascript">
            ...
            if (typeof TYPE_MESSAGE != "undefined")
            {
                switch (TYPE_MESSAGE) {
                    case 'success':
                        $.confirm({
                            title: 'Thông báo',
                            content: 'Xử lý dữ liệu thành công',
                            draggable: true,
                    ...
                    case 'error':
                        $.confirm({
                            title: 'Thông báo',
                            content: 'Xử lý dữ liệu thất bại',
                            draggable: true,
            ...
            $(function(){
                // run select2
                let $element = $(".js-select2-document");
                if ($element.length > 0) {
                    $element.select2({
                ...
                $(".js-process-buy").click(function(event){
                    event.preventDefault();
                    let URL = $(this).attr('href');
                    $.confirm({
                        title: 'Bạn có muốn xử lý dữ liệu không?',
                        type: 'red',
                        buttons: {
                            ok: {
                                text: "ok!",
